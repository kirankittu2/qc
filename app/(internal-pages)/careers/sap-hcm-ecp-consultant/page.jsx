...
export const metadata = {
  title: "SAP HCM/ECP Consultant | Qcentrio Careers",
};
    ...
    <div className="job-description-section">
      ...
      <table data-option="up" className="animate animate-hidden">
        <tbody>
          ...
          <tr>
            <th>Base Location:</th>
            <td>Hiring office located in Any where in india</td>
          </tr>
          <tr>
            <th>Education:</th>
            <td>UG: B.Tech/B.E. in Any Specialization , Any Graduate</td>
          </tr>
          <tr>
            <th>Mandatory Skill:</th>
            {/* <td>
              SAP HCM Consultant, Employee Central, SAP ECP, SuccessFactors,
              Employee Central Payroll, SAP Employee Central Payroll, SAP EC,
              SAP EC PAYROLL, Indian Taxation, US Payroll, Payroll, SAP HCM,
              HCM, ECP, SAP HR, SAP Employee Central, Compensation, Sap Success
              Factor, Sap Successfactors.
            </td> */}
          </tr>
        </tbody>
      </table>
      <ul className="job-description-section-content">
        <li>
          Minimum 10Yrs experience in SAP HCM Payroll + SuccessFactors Payroll
          with SF EC / EC payroll modules. Required expertise in Indian Payroll.
        </li>
        <li>
