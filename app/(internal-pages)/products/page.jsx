...
export const metadata = {
  ...
  // title: "Authorized Partner of Qcentrio Banking Solutions | Qcentrio",
  description:
  ...
  // description:
  //   "Discover banking and financial solutions from Qcentrio, including Remitree, Conciliare, and Sherlock, available globally through Qcentrio. Enhance your operations with our trusted, innovative technology in the US.",
};
      ...
      <div className="products-hero-main">
        <div>
          ...
          <h1
            data-option="strip-slide-up"
            className="products-hero-main-heading animate strip-slide-up strip-slide-grey">
            EMPOWER YOUR BANKING SERVICES WITH QCENTRIO SOLUTIONS
          </h1>
          <p
            data-option="up"
  ...
  return (
    <div className="products-brief-section balance-section">
      ...
      {/* <h2
        data-option="strip-slide-up"
        className="section-heading animate strip-slide-up strip-slide-grey">
        Tailored Qcentrio Solutions for the Financial Industry
      </h2> */}
  ...
  return (
    <div className="balance-section sub-services-why-choose-section">
      ...
      <h2
        data-option="strip-slide-up"
        className="section-heading animate strip-slide-up strip-slide-white">
        PROVIDING UNMATCHED VALUE TO FINANCIAL INSTITUTIONS BY
        DISTRIBUTING QCENTRIO’S SOLUTIONS
      </h2>
